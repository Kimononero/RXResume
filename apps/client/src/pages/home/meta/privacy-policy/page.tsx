...
export const PrivacyPolicyPage = () => (
  <main className="relative isolate bg-background">
    <Helmet prioritizeSeoTags>
      <title>
        {t`Privacy Policy`} - {t`Resumate`}
      </title>

      <meta
        name="description"
        content="An AI assisted Resume Builder that simplifies the process of creating, updating, and sharing your resume."
      />
    </Helmet>
      ...
      <ol>
        <li>
          ...
          <p>
            ...
            you provide when using our web application. By accessing or using Resumate, you
        ...
        <li>
          ...
          <p>
            Resumate is committed to ensuring the security of your data. Our application and
